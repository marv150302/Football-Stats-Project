...
const clubsRouter = require('./club');
const competitionsRouter = require('./competition');
const gamesRouter = require('./game');
const gameEventsRouter = require('./game_event');
const gameLineupsRouter = require('./games_lineup');
const playersRouter = require('./player');
const playerValuationsRouter = require('./player_valuation');
...
/**
 * Mountning the different routes
 * ***The routes should be more defined in terms of 'name', but time wasn't by my side
 * ***so I couldn't adjust them
 * for example --> router.use('/api', appearancesRouter) should be: router.use('/api/appearances', appearancesRouter)
 */
router.use('/api', appearancesRouter);
router.use('/api', clubsRouter);
router.use('/api', competitionsRouter);
router.use('/api', gamesRouter);
router.use('/api', gameEventsRouter);
router.use('/api', gameLineupsRouter);
router.use('/api', playersRouter);
router.use('/api', playerValuationsRouter);
...
router.get('/stats', function (req, res) {
  const locals = {
    ...
    description: 'Find stats about a player, club or competition'
  }
  res.render('stats', {locals});
});
